...
export class MockProjectRepository implements ProjectRepository {
  ...
  async update(id: string, patch: UpdateProjectInput): Promise<Project> {
    ...
    if (
      ...
      normalizeName(patch.name) !== normalizeName(current.name)
    ) {
    ...
    const next: Project = {
      ...
      ...(patch.gitRepoUrl !== undefined
        ? { gitRepoUrl: patch.gitRepoUrl }
        : {}),
      ...(patch.kbRepoFullName !== undefined
        ? { kbRepoFullName: patch.kbRepoFullName }
        : {}),
  ...
  listDispatcherCandidates(): Promise<never> {
    return Promise.reject(
      new Error("Mock.listDispatcherCandidates: not implemented"),
    );
  }
  ...
  setMultiTaskWorker(): Promise<never> {
    return Promise.reject(
      new Error("Mock.setMultiTaskWorker: not implemented"),
    );
  }
  ...
  setPublicAppearance(): Promise<never> {
    return Promise.reject(
      new Error("Mock.setPublicAppearance: not implemented"),
    );
  }
  ...
  getAppBackendDashboard(): Promise<never> {
    return Promise.reject(
      new Error("Mock.getAppBackendDashboard: not implemented"),
    );
  }
  getAppDashboardSettings(): Promise<never> {
    return Promise.reject(
      new Error("Mock.getAppDashboardSettings: not implemented"),
    );
  }
  updateAppDashboardSettings(): Promise<never> {
    return Promise.reject(
      new Error("Mock.updateAppDashboardSettings: not implemented"),
    );
  }
  verifyAppCustomDomain(): Promise<never> {
    return Promise.reject(
      new Error("Mock.verifyAppCustomDomain: not implemented"),
    );
  }
  testAppWebhook(): Promise<never> {
    return Promise.reject(new Error("Mock.testAppWebhook: not implemented"));
  }
  scanAppSecurity(): Promise<never> {
    return Promise.reject(new Error("Mock.scanAppSecurity: not implemented"));
  }
  listAppRuntimeUsers(): Promise<never> {
    return Promise.reject(
      new Error("Mock.listAppRuntimeUsers: not implemented"),
    );
  }
  revokeAppRuntimeUserSessions(): Promise<never> {
    return Promise.reject(
      new Error("Mock.revokeAppRuntimeUserSessions: not implemented"),
    );
  }
  deleteAppRuntimeUser(): Promise<never> {
    return Promise.reject(
      new Error("Mock.deleteAppRuntimeUser: not implemented"),
    );
  }
  queryAppRows(): Promise<never> {
    return Promise.reject(new Error("Mock.queryAppRows: not implemented"));
  }
  createAppRow(): Promise<never> {
    return Promise.reject(new Error("Mock.createAppRow: not implemented"));
  }
  updateAppRow(): Promise<never> {
    return Promise.reject(new Error("Mock.updateAppRow: not implemented"));
  }
  deleteAppRow(): Promise<never> {
    return Promise.reject(new Error("Mock.deleteAppRow: not implemented"));
  }
  updateAppTablePermissions(): Promise<never> {
    return Promise.reject(
      new Error("Mock.updateAppTablePermissions: not implemented"),
    );
  }
  getAppBackendLogs(): Promise<never> {
    return Promise.reject(new Error("Mock.getAppBackendLogs: not implemented"));
  }
  getGitTokenDelegation(): Promise<never> {
    return Promise.reject(
      new Error("Mock.getGitTokenDelegation: not implemented"),
    );
  }
  setGitTokenDelegation(): Promise<never> {
    return Promise.reject(
      new Error("Mock.setGitTokenDelegation: not implemented"),
    );
  }
  listGitTokenAccessLog(): Promise<never> {
    return Promise.reject(
      new Error("Mock.listGitTokenAccessLog: not implemented"),
    );
  }
  ...
  listMembers(projectId: string): Promise<ProjectMember[]> {
    return Promise.reject(
      new Error(`Mock.listMembers(${projectId}): not implemented`),
    );
  }
  ...
  requestJoin(projectId: string): Promise<void> {
    return Promise.reject(
      new Error(`Mock.requestJoin(${projectId}): not implemented`),
    );
  }
  resolveJoinRequest(requestId: string, accept: boolean): Promise<void> {
    return Promise.reject(
      new Error(
        `Mock.resolveJoinRequest(${requestId}, ${accept}): not implemented`,
      ),
    );
  }
  listSharedMembers() {
  ...
  getProjectAnalytics(): Promise<never> {
    return Promise.reject(
      new Error("Mock.getProjectAnalytics: not implemented"),
    );
  }
  getProjectActivity(): Promise<never> {
    return Promise.reject(
      new Error("Mock.getProjectActivity: not implemented"),
    );
  }
