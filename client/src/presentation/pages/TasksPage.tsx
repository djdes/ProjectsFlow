    ...
    <div className="flex min-h-full flex-col" data-pf-project-page>
      ...
      <div
        className={cn(
          ...
          // названия = 36px; низ ПОСЛЕДНЕГО ВИДИМОГО элемента шапки → ряд вкладок = 12px.
          //
          // Прежние 40px здесь были ошибкой чтения эталона: 40 — это расстояние от низа
          // ТЕКСТА названия до вкладок, и в него уже входит строка описания (заголовочный
      ...
      >
        ...
        {descriptionVisible && (
          ...
          // #3: на десктопе верхнего отступа НЕТ — в Notion описание примыкает к названию
