...
// компонент для инбокс-карточек (ответственный) и ряда участников. Тултип-провайдер — глобальный
...
export function UserAvatarHover({
  ...
  // Строка под именем в раскрытии (например «ответственный», «выполняет»).
  subtitle?: string;
