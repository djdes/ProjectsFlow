...
export function CanvasRouteMap({ routes, baseUrl, onOpenRoute }: { routes: string[]; baseUrl: string; onOpenRoute: (path: string) => void }): React.ReactElement {
