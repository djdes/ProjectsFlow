        ...
        {loading ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {/* Сверка коммитов (db/072): воркер раз в день (или по кнопке) сопоставляет свежие
                коммиты с задачами в колонке «Черновики» и, найдя реализацию, закрывает задачу. */}
            <AutomationCard
              icon={RefreshCw}
              title="Сверка коммитов"
              description="Раз в день (или по кнопке) сверяет коммиты репозитория с задачами в первой колонке «Черновики». Нашёл коммит, который реализует черновик, — задача уходит в «Готово» (или предложение закрыть)."
              toggle={{
