 ...
 *
 * Личные inbox-задачи участвуют наравне с проектными: inbox живёт в рабочем пространстве
 * владельца, и в командном пространстве у личной задачи есть кому её принимать. Серверное
 * правило теперь такое же (TaskApprovalService.requiresApproval больше не исключает
 * project.isInbox), так что жест и сервер снова говорят одно и то же.
 *
