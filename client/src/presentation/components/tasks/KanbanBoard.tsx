...
export function KanbanBoard({
  ...
  // Мультивыделение протяжкой: зажал на карточке и провёл — все пройденные попадают в
      ...
      {(() => {
        ...
        >
          ...
          {/* Хвостовой спейсер (моб): пустота справа, чтобы ПОСЛЕДНЯЯ колонка вставала по
              ...
              последнем элементе — так работает в обоих случаях). На десктопе скрыт. */}
          <div aria-hidden className="w-[max(4vw,calc(50vw_-_12rem))] shrink-0 sm:hidden" />
        </div>
